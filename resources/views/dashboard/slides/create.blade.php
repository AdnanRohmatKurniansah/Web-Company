...
<div class="col-xl-9 col-lg-7">
    ...
    <div class="card mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">Add New Slide</h5>
        </div>
        <div class="container">
            <form action="/dashboard/slides" method="post" enctype="multipart/form-data" class="m-3">
                  ...
                  <div class="mb-3">
                      ...
                      name="mainTitle" required autofocus value="{{ old('mainTitle') }}">
                      @error('mainTitle')
                  ...
                  <div class="mb-3">
                      ...
                      name="subTitle" required autofocus value="{{ old('subTitle') }}">
                      @error('subTitle')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
