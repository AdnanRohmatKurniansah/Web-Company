              ...
              <form action="/dashboard/customers/{{ $customer->id }}" method="post" enctype="multipart/form-data" class="m-3">
                @method('put')
                  ...
                  <div class="mb-3">
                      ...
                      name="imgName" required autofocus value="{{ old('imgName', $customer->imgName) }}">
                      @error('imgName')
                    ...
                    <div class="mb-3">
                      ...
                      <input type="hidden" name="oldImage" value="{{ $customer->image }}">
                        @if ($customer->image)
                          <img src="{{ asset('storage/' . $customer->image) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                        @else
