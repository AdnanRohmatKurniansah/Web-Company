    ...
    <div class="row">
        ...
        <div class="col-xl-9 col-lg-7">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <a href="/dashboard/customers/create" class="btn btn-primary my-2">Add New Customer</a>
                    <table class="table">
                        <thead>
                          <tr>
                            <th scope="col">#</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{ $customer->imgName }}</td>
                            <td class="d-flex">
                                <a href="/dashboard/customers/{{ $customer->id }}/edit" class="badge bg-info mr-1" style="font-size: 18px"><i class="fa-solid fa-pen-to-square"></i></a>
