    ...
    <div class="portfolio-main">
        ...
        <div id="projects" class="projects-main row">
           <div class="col-lg-4 col-sm-6 pro-item portfolio-item financial">
              <div class="card h-100">
                 <div class="card-img">
                    <a href="/assets/images/portfolio-img-01.jpg" data-fancybox="images">
           ...
           <div class="col-lg-4 col-sm-6 pro-item portfolio-item business academic">
              <div class="card h-100">
                 <div class="card-img">
                    <a href="/assets/images/portfolio-img-02.jpg" data-fancybox="images">
           ...
           <div class="col-lg-4 col-sm-6 pro-item portfolio-item travel">
              <div class="card h-100">
                 <div class="card-img">
                    <a href="/assets/images/portfolio-img-03.jpg" data-fancybox="images">
           ...
           <div class="col-lg-4 col-sm-6 pro-item portfolio-item business">
              <div class="card h-100">
                 <div class="card-img">
                    <a href="/assets/images/portfolio-img-04.jpg" data-fancybox="images">
           ...
           <div class="col-lg-4 col-sm-6 pro-item portfolio-item travel">
              <div class="card h-100">
                 <div class="card-img">
                    <a href="/assets/images/portfolio-img-05.jpg" data-fancybox="images">
                ...
                <div id="blog-slider" class="owl-carousel">
                    <div class="post-slide">
                        <div class="post-header">
                            ...
                            <ul class="post-bar">
                                <li><img src="/assets/images/testi_01.png" alt=""><a href="#">Williamson</a></li>
                    ...
                    <div class="post-slide">
                        <div class="post-header">
                            ...
                            <ul class="post-bar">
                                <li><img src="/assets/images/testi_02.png" alt=""><a href="#">Kristiana</a></li>
                    ...
                    <div class="post-slide">
                        <div class="post-header">
                            ...
                            <ul class="post-bar">
                                <li><img src="/assets/images/testi_01.png" alt=""><a href="#">Kristiana</a></li>
                                <li><i class="fa fa-calendar"></i>05 June 2018</li>
                            </ul>
                        </div>
                        <div class="pic">
